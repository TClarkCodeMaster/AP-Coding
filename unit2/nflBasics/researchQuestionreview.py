from helperFunctions import get_player_stats_by_name, plot_weekly_player_stats,plot_player_stat, get_team_records, get_advanced_team_records, get_position_columns, get_season_Results_By_team , weeklyPlayerStats
...
#QB accuracy affects all overall points and influences team wins by more than 50%
...
def (function) get_team_turnover
'3. Who has the most passing yards of all time ? '
 #There is no way to answer this question, there are too many details and I also cannot use a helper function to search up this information.